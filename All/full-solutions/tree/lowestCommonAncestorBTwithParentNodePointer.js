...
var lowestCommonAncestor = function(p, q) {
    ...
    while(pPointer!==qPointer){
        pPointer = pPointer===null? q : pPointer.parent /// if pPointer is null return q else return pointer.parent
        qPointer = qPointer===null? p : qPointer.parent // if qpointer ===null return p else return qpointer.parent
    }
    return pPointer
};
